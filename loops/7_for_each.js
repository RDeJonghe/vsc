...
gnr.forEach(function(el) {
  console.log(
    `${el.name} used to do a little ${el.drug} but the little got more and more, just keep trying to get a little better, said a little better than before.`
  );
});
